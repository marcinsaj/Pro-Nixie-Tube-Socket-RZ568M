/*----------------------------------------------------------------------*
 * A simple example of how to use 6x Pro Nixie Sockets                  *
 * with RZ568M Nixie Tube.                                              *
 *                                                                      *
 * How to connect 6x Pro Nixie Sockets to the Arduino:                  *
 * https://bit.ly/PRO-6-ARD                                             *
 *                                                                      *
...
{
  NixieDisplay(0, 0, 0, 0, 0, 0);               //Clear shift registers  
}
