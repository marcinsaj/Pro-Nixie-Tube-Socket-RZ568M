/*----------------------------------------------------------------------*
 * A simple example of how to use 2x Pro Nixie Sockets                  *
 * with RZ568M Nixie Tube.                                              *
 *                                                                      *
 * How to connect 2x Pro Nixie Sockets to the Arduino:                  *
...
void NixieDisplay(uint8_t tube2, uint8_t tube1)
{
  ...
  SPI.transfer(nixieDigitArray[tube2] >> 8);    //Send first byte
  SPI.transfer(nixieDigitArray[tube2]);         //Send second byte
...
{
  NixieDisplay(0, 0);                           //Clear shift registers  
}
